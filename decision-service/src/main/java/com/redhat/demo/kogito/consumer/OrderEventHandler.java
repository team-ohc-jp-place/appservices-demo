package com.redhat.demo.kogito.consumer;
...
import com.redhat.demo.kogito.producer.KafkaEventProducer;
import com.redhat.demo.kogito.service.EarthOrderService;
...
public class OrderEventHandler {
    ...
    public void onOrderEvent(String payload) {
        ...
        try {
            ...
            //Kafka Producer
            kafkaEventProducer.onProduceEvent(eventPayload);
